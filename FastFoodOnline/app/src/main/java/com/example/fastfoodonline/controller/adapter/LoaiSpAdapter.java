   ...
   Context context;
    ...
    public View getView(int position, View view, ViewGroup parent) {
       ...
       if(view == null){
        ...
        viewHolder.texttensp.setText(array.get(position).getTenloaisanpham());
        Glide.with(context).load(array.get(position).getHinhanhloaisanpham()).into(viewHolder.imghinhanh);
